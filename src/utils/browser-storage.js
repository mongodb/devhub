...
export const setLocalValue = (key, value) => {
    if (isValidStorage) {
        const prevState = JSON.parse(
            window.localStorage.getItem('mongodb-docs')
        );
...
export const getLocalValue = key => {
    if (
        isValidStorage &&
        JSON.parse(window.localStorage.getItem('mongodb-docs'))
    ) {
...
export const setSessionValue = (key, value) => {
    if (isValidStorage) {
        const prevState = JSON.parse(
            window.sessionStorage.getItem('mongodb-docs')
        );
...
export const getSessionValue = key => {
    if (
        isValidStorage &&
        JSON.parse(window.sessionStorage.getItem('mongodb-docs'))
    ) {
