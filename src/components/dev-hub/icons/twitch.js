...
const Twitch = ({ color = colorMap.greyLightTwo, ...props }) => (
    <svg width="20" height="20" viewBox="0 0 15 16" {...props}>
        <g transform="translate(-426, -3360)" fill={color} fillRule="nonzero">
            <g transform="translate(0, 3246)">
                <g transform="translate(426, 114)">
                    ...
                    <polygon
                        id="Path"
                        points="6.14471545 4.17466667 7.50406504 4.17466667 7.50406504 8.348 6.14471545 8.348"
                    ></polygon>
                    <polygon
                        id="Path"
                        points="9.88325203 4.17466667 11.243252 4.17466667 11.243252 8.348 9.88325203 8.348"
                    ></polygon>
                </g>
            </g>
        </g>
