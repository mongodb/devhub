...
import { darkTheme, lineHeight, size } from './theme';
...
const StyledCode = styled(Code)`
    border: 1px solid ${darkTheme.colorMap.greyDarkThree};
    ...
    > div {
        ...
        border-image: linear-gradient(
                0deg,
                ${darkTheme.colorMap.sherbet} 0%,
                ${darkTheme.colorMap.salmon} 49.99%,
                ${darkTheme.colorMap.magenta} 100%
            )
            1;
