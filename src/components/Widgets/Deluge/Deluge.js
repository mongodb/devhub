...
class Deluge extends Component {
    ...
    setupStitch = () => {
        try {
            ...
            this.stitchClient = Stitch.hasAppClient(appId)
    ...
    sendVote = vote => {
        ...
        if (segmentEvent.segmentUID) {
            ...
            voteDocument['q-segmentAnonymousID'] =
                segmentEvent.segmentAnonymousID;
        }
    ...
    sendFeedback = (vote, fields) => {
        ...
        return this.stitchClient.callFunction('submitFeedback', [
            query,
            update,
        ]);
    };
