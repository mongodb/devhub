...
const mountCardPills = () =>
    mount(<CardPills pillsNode={pillsNode} pillsetName="drivers" />);
const shallowCardPills = () =>
    shallow(<CardPills pillsNode={pillsNode} pillsetName="drivers" />);
